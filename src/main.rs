...
fn main() {
    // Leemos los archivos jason
    let path = Path::new("C:/Users/zaboo/OneDrive/Documentos/CIMAT/Algoritmos/ProyectoFinal/rust-tutorial-master/resources/1663154348643_8ZGUJJLLWV/ml_data/1663154348643_8ZGUJJLLWV.json");
    let path_test = Path::new("C:/Users/zaboo/OneDrive/Documentos/CIMAT/Algoritmos/ProyectoFinal/rust-tutorial-master/resources/1663154348643_8ZGUJJLLWV/ml_data/1663154348643_8ZGUJJLLWV.json");
    
    let datos = read_ml_json(&path);
    let datos_test = read_ml_json(&path_test);

    //Encontramos los nodos que contiene XX
    let nodos_chidos = encuentra_xx(&datos).unwrap();
    ...
    let nodos_comparar = nodos_con_texto( &tag , &datos_test );
